...
namespace SickToolbox {
   ...
   */
  sick_lms_2xx_type_t SickLMS2xx::GetSickType( ) const{
   ...
   */
  double SickLMS2xx::GetSickScanAngle( ) const{
   ...
   */
  double SickLMS2xx::GetSickScanResolution( ) const {
   ...
   */
  sick_lms_2xx_measuring_units_t SickLMS2xx::GetSickMeasuringUnits( ) const {
   ...
   */
  sick_lms_2xx_sensitivity_t SickLMS2xx::GetSickSensitivity( ) const{
   ...
   * \return Sensitivity level (sick_lms_2xx_sensitivity_t)
   */
  sick_lms_2xx_peak_threshold_t SickLMS2xx::GetSickPeakThreshold( ) const {
   ...
   */
  sick_lms_2xx_measuring_mode_t SickLMS2xx::GetSickMeasuringMode( ) const {
   ...
   */
  sick_lms_2xx_operating_mode_t SickLMS2xx::GetSickOperatingMode( ) const {
   ...
   */
  uint8_t SickLMS2xx::GetSickAvailability( ) const {
   ...
   */
  sick_lms_2xx_status_t SickLMS2xx::GetSickStatus( ) {
   ...
   */
  bool SickLMS2xx::IsSickLMS2xxFast() const {
   ...
   */
   void SickLMS2xx::_setupConnection() {
   ...
   * \param delay Delay to wait for SICK to power on. (In seconds)
   */
  void SickLMS2xx::_setupConnection( const uint32_t delay )  {
    try {
      /* Open the device */
      std::cout << "\t Opening device " << std::endl << std::flush;
      ...
      std::cout << "\tSleeping for "  << delay << " seconds" << std::endl << std::flush;
      sleep(delay);
      ...
      std::cout << "\tSetting default baudRate: "  << DEFAULT_SICK_LMS_2XX_SICK_BAUD << std::endl << std::flush;
      _setTerminalBaud(_baudToSickBaud(DEFAULT_SICK_LMS_2XX_SICK_BAUD));
      std::cout << "\tDone Setting default baudRate" << std::endl << std::flush;
    }
   ...
   */
  void SickLMS2xx::_teardownConnection( ) {
   ...
   */
  void SickLMS2xx::_flushTerminalBuffer( )  {
   ...
   */
  void SickLMS2xx::_sendMessageAndGetReply( 
              const SickLMS2xxMessage &send_message,
   ...
   */
  void SickLMS2xx::_setSessionBaud(const sick_lms_2xx_baud_t baud_rate) 
  {
    SickLMS2xxMessage message, response;
    ...
    try {
      ...
      std::cout << "sending Message to SICK" << std::endl;
      _sendMessageAndGetReply(message,response,DEFAULT_SICK_LMS_2XX_SICK_MESSAGE_TIMEOUT,DEFAULT_SICK_LMS_2XX_NUM_TRIES);
      //_sendMessageAndGetReply(message,response,5e6,10);

      /* Set the host terminal baud rate to the new speed */
      std::cout << "sendTerminalBR" << std::endl;
   ...
   */
  bool SickLMS2xx::_testSickBaud(const sick_lms_2xx_baud_t baud_rate) {
   ...
   */
  void SickLMS2xx::_setTerminalBaud( const sick_lms_2xx_baud_t baud_rate ) 
  {
    struct termios term;
   ...
   */
  void SickLMS2xx::_getSickConfig( ) {
   ...
   */
  void SickLMS2xx::_getSickStatus( ) {
